...
class Paths:
    ...
    knowledgebot_path: Path = field(default_factory=lambda: get_path_from_env(
        "KNOWLEDGEBOT_PATH",
    ...
    def __post_init__(self):
        ...
        self.audio_input = self.knowledgebot_path / "Audio" / "Incoming"
        self.audio_processed = self.knowledgebot_path / "Audio" / "Processed"
        self.transcriptions = self.vault_knowledgebot_path / "Transcriptions"
        
        # Note processing paths
        self.meditations = self.vault_knowledgebot_path / "Meditations"
        self.ideas = self.vault_knowledgebot_path / "Ideas"
        self.ideas_directory = self.vault_knowledgebot_path / "Ideas Directory.md"
        self.todo_directory = self.vault_knowledgebot_path / "Todo Directory.md"
